    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'client_secret':
          ...
          break;
        case 'client_sim':
          result.clientSim = serializers.deserialize(value,
              specifiedType: const FullType(String)) as String?;
          break;
        case 'simbase_key':
...
class UsersRecordBuilder implements Builder<UsersRecord, UsersRecordBuilder> {
  ...
  String? _clientSim;
  String? get clientSim => _$this._clientSim;
  set clientSim(String? clientSim) => _$this._clientSim = clientSim;
