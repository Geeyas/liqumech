  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        // --->> widget added to prevent bottom overflowed pixxels
        child: SafeArea(
          child: Stack(
            children: [
              Image.asset(
                'assets/images/liquimech_arrow_red.png',
                // changed the height and width of the background image according to the screen size
