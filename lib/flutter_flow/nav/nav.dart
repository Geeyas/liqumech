...
class AppStateNotifier extends ChangeNotifier {
  LiquimechCloudFirebaseUser? initialUser;
  LiquimechCloudFirebaseUser? user;
  ...
  void update(LiquimechCloudFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              path: 'mySimbaseDevice',
              builder: (context, params) => MySimbaseDeviceWidget(),
            ),
            FFRoute(
              name: 'ThingName',
              path: 'thingName',
              builder: (context, params) => ThingNameWidget(),
            ),
            FFRoute(
              name: 'IsStatus',
              path: 'isStatus',
              builder: (context, params) => IsStatusWidget(),
            ),
            FFRoute(
              name: 'NonStatus',
              path: 'nonStatus',
            ...
            FFRoute(
              name: 'IsStatusDevice',
              path: 'isStatusDevice',
              builder: (context, params) => IsStatusDeviceWidget(),
            ),
            FFRoute(
              name: 'NonStatusDevice',
              path: 'nonStatusDevice',
              builder: (context, params) => NonStatusDeviceWidget(),
            )
